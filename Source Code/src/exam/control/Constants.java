...
public class Constants {
    ...
    public static String restartall = "RESTARTALL";
    public static String sleepall = "SLEEPALL";
    
    public static String onallmodules = "ONALLMODULES";
    
    
    public static String app1name;
    public static String app2name;
    public static String app3name;
    public static String app4name;
    public static String app5name;
}
